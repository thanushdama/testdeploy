...
def preprocess_data(df):
    ...
    df = df.drop(['Wind direction','Bearing Temp','BladePitchAngle','GearBoxSumpTemp','Generator Speed','Hub Speed','Power','Wind Speed','GearTemp','FaultCode1','FaultCode2','FaultCode3','FaultCode4','FaultCode5','Failure'], axis=1)
